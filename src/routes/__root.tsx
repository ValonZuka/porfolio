  ...
  head: () => ({
    meta: [
      ...
      { title: "Valon Zuka — Cloud, Security & Blockchain Engineer" },
      {
        name: "description",
        content:
          "Portfolio of Valon Zuka — cloud architecture, security engineering, smart contracts and shipped web products.",
      },
      { name: "author", content: "Valon Zuka" },
      { property: "og:title", content: "Valon Zuka — Cloud, Security & Blockchain Engineer" },
      {
        property: "og:description",
        content: "Cloud, security and blockchain engineering from Kosovo.",
      },
